...
public class ResultsActivity extends Activity implements OnSharedPreferenceChangeListener  {
	...
	private void searchNew(String query) {
		...
		ConnectionThread dataThread = new ConnectionThread(
			link, threadConnectionHandler, ResultsActivity.this, currentFunction);
		dataThread.start();
	}
	...
	private void fillList() {		 
		...
		listResults.setAdapter(new CompanyAdapter(ResultsActivity.this, R.layout.company_box, 
	...
	private void showAToast(String st) {
		try {
			if (toast != null) {
				...
				toast = Toast.makeText(ResultsActivity.this, st,
						Toast.LENGTH_SHORT);
			}
		} catch (Exception e) {
