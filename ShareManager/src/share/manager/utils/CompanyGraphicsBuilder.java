...
public class CompanyGraphicsBuilder {
	...
	public CompanyGraphicsBuilder(final Activity context,
			ArrayList<Float> stockValues, ArrayList<String> dates, View view) {
		...
		mRenderer.setXTitle("From " + dates.get(0) + " to "
